...
public class NewDTGMain extends Application
{
    ...
    {
        GregorianCalendar startDate = new GregorianCalendar(2012, 11, 20);
        ...
        GregorianCalendar startOfEvent1 = new GregorianCalendar(2012, 11, 25);
        GregorianCalendar endOfEvent1 = new GregorianCalendar(2012, 12, 5);
        EventTime ev1 = new EventTime("Title1", "Description", startOfEvent1, endOfEvent1, d1);
        d1.addEventTime(ev1);

//        GregorianCalendar startOfEvent2 = new GregorianCalendar(2012, 12, 2);
//        GregorianCalendar endOfEvent2 = new GregorianCalendar(2012, 12, 15);
//        EventTime ev2 = new EventTime("Title2", "Description", startOfEvent2, endOfEvent2);
//        d1.addEventTime(ev2);
//
//        GregorianCalendar startOfEvent3 = new GregorianCalendar(2012, 12, 1);
//        GregorianCalendar endOfEvent3 = new GregorianCalendar(2012, 12, 15);
...
//        GregorianCalendar startOfEvent5 = new GregorianCalendar(2012, 11, 24);
//        GregorianCalendar endOfEvent5 = new GregorianCalendar(2012, 12, 15);
//        EventTime ev5 = new EventTime("Title5", "Description", startOfEvent5, endOfEvent5);
//        d1.addEventTime(ev5);
//
//        GregorianCalendar dateEventNT = new GregorianCalendar(2012, 12, 15);
